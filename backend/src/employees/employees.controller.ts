...
export class EmployeesController {
  ...
  @ApiOperation({
    ...
    description:
      'Returns a filtered, pageable list of employees. Accessible by all authenticated roles.',
  })
  @ApiQuery({
    name: 'search',
    required: false,
  ...
  @ApiQuery({
    name: 'status',
    required: false,
    description: 'Filter by status: active | blocked | on_leave | terminated',
    enum: ['active', 'blocked', 'on_leave', 'terminated'],
  })
  @ApiQuery({
    name: 'departmentId',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Returns aggregate counts: total, active, blocked, on_leave, terminated, and breakdown by department.',
  })
  @ApiOkResponse({
    description:
      'Employee stats object with total, active, blocked, onLeave, and byDepartment array',
  })
  getStats() {
  ...
  @ApiOperation({
    ...
    description:
      'Permanently removes the employee record. Requires **admin** role.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Employee ID to block',
    example: 1,
  })
  ...
  @ApiParam({
    name: 'id',
    type: Number,
    description: 'Employee ID to unblock',
    example: 1,
  })
