...
const SecurityLogsPage: React.FC = () => {
    ...
    const getDeviceIcon = (userAgent: string) => {
        if (userAgent.toLowerCase().includes("mobile"))
            return <Monitor size={14} className="text-blue" />
    ...
    const renderTableContent = () => {
        ...
        return logs?.map?.((log) => (
            ...
            >
                ...
                <td>
                    <span
                        className={`badge ${log.action === "LOGIN" ? "badge-active" : "badge-terminated"}`}
                    >
                        {log.action}
                    </span>
                </td>
            ...
            <div className="page-header">
                <div>
                    ...
                    <p className="text-text-secondary mt-1">
                        Track all system authentication events and access
                        attempts.
                    </p>
                </div>
                <button
