            ...
            <div className="auth-hero-side">
                ...
                <div className="auth-hero-content">
                    ...
                    <p className="auth-hero-subtitle">
                        Join thousands of managers who trust EmpManager for
                ...
                <div className="auth-form-container">
                    {showSuccess ? (
                        ...
                        >
                            ...
                            <p
                                className="auth-v2-subtitle"
                                style={{ marginBottom: "32px" }}
                            >
                                Thank you for signing up. Your account is
                                currently pending approval by an administrator.
                            </p>
                            <button
                                onClick={() => navigate("/login")}
                                className="auth-v2-btn"
                            >
                        ...
                        <>
                            <div style={{ marginBottom: "40px" }}>
                                ...
                                <p className="auth-v2-subtitle">
                                    ...
                                    <Link to="/login" className="auth-v2-link">
                                        Log in
                                    </Link>
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                >
                                    <div
                                        className="auth-v2-input-group"
                                        style={{ marginBottom: 0 }}
                                    >
                                        <label
                                            htmlFor="firstName"
                                            className="auth-v2-label"
                                        >
                                            First Name
                                        </label>
